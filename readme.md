...
L’application applique le principe du moindre privilège :
chaque rôle dispose uniquement des actions nécessaires à sa mission.
...
suivre les exceptions en production

monitorer les événements importants

Configuration via variable d’environnement SENTRY_DSN.
